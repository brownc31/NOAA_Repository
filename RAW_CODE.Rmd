...
```{r, results = 'hide'}
ecoa3_raw <- read_excel("~/Desktop/NOAA/NOAA Work/East Coast/ECOA-3/ECOA3_CTD_Colin_Brown.xlsx") %>% 
...
```{r}
ecoa3_corrected <- read_excel("~/Desktop/NOAA/NOAA Work/East Coast/ECOA-3/ECOA_3_CTD_MasterDataSheet_09_26_2023.xlsx") %>% 
   slice(-1)
